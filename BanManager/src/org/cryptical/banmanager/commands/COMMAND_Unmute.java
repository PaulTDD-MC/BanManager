...
public class COMMAND_Unmute implements CommandExecutor, TabCompleter{
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		Punisher.unmute(target);

		Bukkit.getPluginManager().callEvent(new PlayerUnmuteEvent(target));
		Bukkit.getPluginManager().callEvent(new PlayerPunishedEvent(target, PunishReason.UNMUTE));
		return true;
	}
